...
class MainForm(QWidget):
    def __init__(self, name = 'MainForm'):
        ...
        self.cwd = os.getcwd() #获取当前程序文档的位置
        self.resize(300,200) #设置框体窗口大小
        #btn 1
        ...
        self.btn_chooseFile.setText("选择文件")
        ...
        self.btn_chooseDir.clicked.connect(self.slot_)
        self.btn_chooseFile.clicked.connect(self.btn_chooseFile)

        self.btn_saveFile.clicked.connect(self.btn_saveFile)
